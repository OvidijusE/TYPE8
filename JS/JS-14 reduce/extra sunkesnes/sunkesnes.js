...
const infromatika = students.filter((stuObj) => stuObj.faculty === "Informatikos fakultetas");
console.table(infromatika);

// 3. Atrenkame visus Chemijos fakulteto studentus
const chemija = students.filter((stuObj) => stuObj.faculty === "Chemijos fakultetas");
console.table(chemija);

// 4. Atrenkame visus Elektros ir elektronikos fakulteto studentus
const elektraElektronika = students.filter((studObj) => studObj.faculty === "Elektros ir elektronikos fakultetas");
console.table(elektraElektronika);
...
const pirmasKursas = students.filter((studObj) => studObj.course === 1);
console.table(pirmasKursas);
// 9. Atrenkame tik antro kurso studentus
const antrasKursas = students.filter((studObj) => studObj.course === 2);
console.table(antrasKursas, ["name", "surname", "course"]);
// 10.Atrenkame tik trečio kurso studentus
// nera tokiu
const treciasKursas = students.filter((studObj) => studObj.course === 3);
console.table(treciasKursas);
// 11.Atrenkame tik ketvirto kurso studentus
// nera tokiu
const ketvirtasKursas = students.filter((studObj) => studObj.course === 4);
console.table(ketvirtasKursas);
