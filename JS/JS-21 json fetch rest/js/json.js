...
// is Json verciam i JS objektus masyvus ir t.t.
// JSON.parse()
...
console.log("u1BackToJS ===", u1BackToJS);

// paverciam peopleObjs i json ir gauta json issaugom kaip people.json

const peopleObjToJSON = JSON.stringify(peopleObjs);
console.log("peopleObjToJSON ===", peopleObjToJSON);

// atsiversti atgal is json i js ir isitikinti kad veikia
const JSONtoJs = JSON.parse(peopleObjToJSON);
console.log("JSONtoJs ===", JSONtoJs);
