...
const kaunieciai = studentsFrom("Siauliai");
...
document.body.addEventListener("click", (e) => {
  ...
  //suzinoti ar paspaudem ant el kuris turi klase "del-stud"
...
function makeStudCard(stObj) {
  const gender = stObj.gender === `male` ? "man" : "wonan";
...
// function makeEl(tag, className, text, destination) {}
