...
const menCount = data.filter((obj) => obj.gender === "Male").length;
console.log(`Sioje imoneje yra ${menCount} vyrai.`);

// 2.Sukurkite masyvą, kuriuose būtų id visų žmonių, kurie turi automobilius naujesnius nei 2000 metai.

const auto = data.filter((object) => object.car_year > 2000).map((ob) => ob.id);
console.table(auto);
